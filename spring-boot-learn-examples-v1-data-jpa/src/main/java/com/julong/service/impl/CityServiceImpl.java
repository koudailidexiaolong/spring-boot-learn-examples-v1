...
public class CityServiceImpl implements CityService {
	...
	@Override
	public int delete(int cityId) throws Exception {
		// TODO Auto-generated method stub
		int result = 0;
		this.cityRepositoryImpl.delete(cityId);
		result = 1;
		return result;
	}

	@Override
	public CityInfo save(CityInfo cityInfo) throws Exception {
		// TODO Auto-generated method stub
		CityInfo info = this.cityRepositoryImpl.save(cityInfo);
		return info;
	}
